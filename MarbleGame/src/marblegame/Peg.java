...
/**
 *
 * this is the pegs for a level
 * 
 */
public class Peg {
    public int imageId;     //id of image to draw peg (serialization )
    public int imageHitId;  //id of the hit image to draw the peg (serialization)
    public Sprite image;       //the actual sprite
    public Sprite imageHit;     //the srpite when the peg is hit or being destroyed by monster
    public long timeHit;        //the time the sprite was initially hit
    public boolean active;      //is the peg active
   ...
   //sets a location of the peg
    ...
    //creates a string of data from a peg
    ...
    //creates a peg from a string of data
